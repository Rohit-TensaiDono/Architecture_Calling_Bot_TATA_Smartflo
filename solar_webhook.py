...
STATE_PRICE_AND_PAYMENT = (
    "మా ప్రాజెక్ట్ లో గజం భూమి ధర కేవలం వేయి రూపాయలు మాత్రమే. "
    "మీరు ఎంచుకునే విస్తీర్ణాన్ని బట్టి మొత్తం ధర ఉంటుంది. "
...
PRE_RECORDED_AUDIO = {
    ...
    STATE_PRICE_AND_PAYMENT: "static/pre_audio/STATE_PRICE_AND_PAYMENT.wav",
...
def handle_state_3(session_id, user_text_low, user_text_safe):
    ...
    size_keywords = ["ఎకరం", "acre", "acres", "పావు", "అర"]
    ...
    if gave_size:
        ...
        if asking_price:
            ...
            return STATE_PRICE_AND_PAYMENT
    ...
    if asking_price:
        ...
        sessions[session_id]["retries"] = 0
        return STATE_PRICE_AND_PAYMENT   # named constant → pre-recorded lookup works
...
_STATE_QUESTION_MAP_EN = {
    "STATE_1": (
        ...
        "We have a Sattva Organic Farm project located around 90 km from Hyderabad ORR, "
        "available at an early launch offer of just ₹999 per square yard. "
        "With managed sandalwood farming, earn up to ₹2 lakhs/year and ₹4 crores over 15 years. "
        "Would you like to know more?"
    ),
    "STATE_2": "May I know what purpose you are considering this land for — investment or farmhouse?",
    "STATE_3": "Approximately how much land are you looking for? Quarter acre, half acre, or one acre?",
    "STATE_4": "How would you prefer to make the payment — full payment or EMI?",
    "STATE_5": "When are you planning to invest — within 1 month, 1–3 months, or just exploring?",
    "STATE_6": (
        "We offer a free site visit every Sunday with pickup facility. "
        "Would you like us to arrange a visit this Sunday, or another date?"
    ),
    "STATE_7": (
        "Thank you! Your details have been recorded. "
        "Our team will call to confirm your site visit. "
        "Thank you for choosing Unnati Land & Infra!"
    ),
}
